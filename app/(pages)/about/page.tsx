...
const AboutPage: React.FC = () => {
      ...
      <div className="bg-gray-900 text-gray-100 min-h-screen px-4 md:px-10 lg:px-20 py-16 ">
        ...
        <header className="text-center mb-16 relative z-10 animate-fadeIn">
          <h1 className="text-4xl md:text-6xl font-bold text-white tracking-wide">
            À Propos de ReserVite
          </h1>
          <p className="mt-4 text-lg text-gray-300 max-w-2xl mx-auto">
            {`Découvrez notre mission, nos valeurs et notre équipe passionnée,
            dédiée à simplifier vos réservations d'espaces.`}
          </p>
        </header>
  ...
  pour aider nos clients à réaliser leurs projets et événements dans un cadre inspirant.
        ...
        <section className="relative z-10 mb-20">
          ...
          <div className="flex flex-wrap gap-8 justify-center">
            {[
              {
                title: "Simplicité",
                desc: "Rendre la réservation rapide et facile pour tous.",
              },
              {
                title: "Flexibilité",
                desc: "Offrir des espaces variés pour chaque besoin.",
              },
              {
                title: "Accessibilité",
                desc: "Permettre à chacun de réserver un espace.",
              },
            ].map((value, idx) => (
              <div
                key={idx}
                className="w-64 p-6 bg-gray-800 rounded-lg shadow-md text-center transform transition hover:scale-105"
              >
        ...
        <section className="relative z-10 mb-20 text-center">
          <h2 className="text-3xl font-semibold mb-6 text-gray-50">
